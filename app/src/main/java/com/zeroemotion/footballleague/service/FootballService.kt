...
//    fun getNextMatch(id: String?): Single<MatchResponse> {
//        return retrofit.getNextMatch(id)
//    }
//
//    fun getPrevMatch(id: String?): Single<MatchResponse> {
//        return retrofit.getPrevMatch(id)
//    }
//
//    fun getDetailLeague(id: String?): Single<LeagueResponse> {
//        return retrofit.getDetailLeague(id)
//    }
//
//    fun getSearchMatch(e: String?): Single<SearchResponse> {
//        return retrofit.getSearchMatch(e)
//    }
//
//    fun getDetailHome(id: Int?): Single<TeamsResponseHome> {
//        return retrofit.getDetailTeamHome(id)
//    }
//
//    fun getDetailAway(id: Int?): Single<TeamsResponseAway> {
//        return retrofit.getDetailTeamAway(id)
//    }
//
